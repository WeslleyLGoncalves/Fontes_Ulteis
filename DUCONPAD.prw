...
+-----------+------------+----------------+-------------------+-------+---------------+
| Descricao | Programa de atualiza consulta padrão de dicionarios diferentes          |
+-----------+-------------------------------------------------------------------------+
| Modulos   | SIGACFG                                                                 |
+-----------+-------------------------------------------------------------------------+
| Processos |                                                                         |
	...
	If lOk
		...
		If !Empty( aMarcadas )
			If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
				...
				If lAuto
					If lOk
						MsgStop( "Atualização Realizada.", "DUCONPAD" )
					Else
						MsgStop( "Atualização não Realizada.", "DUCONPAD" )
					EndIf
					dbCloseAll()
				Else
					If lOk
...
Static Function LerArqui()
	...
	*                        *
	**************************
	//Este exemplo, apresenta como o DBF corrente pode ser exibido para o usuário.
